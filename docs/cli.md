...
agent-symphony control --repository owner/repository --runtime-state path --action archive|abandon --issue number --attempt number --confirm [--request-id id] [--timeout duration] [--json]
